...
SECRET_KEY = "django-insecure-7uuib9rnfxs)m7a+91zh-iq&8$yvy)dwz6ky!y(f(igc7x$1o0"
...
JAZZMIN_SETTINGS = {
    ...
    "site_icon": "images/logo_icon.svg",

    # Welcome text on the login screen
    "welcome_sign": "Seja bem-vindo ao Parking Service",

    # Copyright on the footer
    "copyright": "Winston de Moura",
